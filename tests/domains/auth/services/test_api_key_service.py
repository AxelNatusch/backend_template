...
class TestAPIKeyService:
    ...
    def test_create_api_key(self, mock_generate_api_key, api_key_service):
        ...
        mock_generate_api_key.return_value = ("test_api_key_12345", "hashed_key_value")
    ...
    def test_get_user_api_keys(self, api_key_service, test_api_key_in_db, revoked_api_key_in_db, expired_api_key_in_db):
