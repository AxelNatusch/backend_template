...
class TestAPIKeyEndpoints:
    ...
    def test_create_api_key(
        ...
        # Make the request
        response = client.post("/auth/api-keys/", json={"name": "Test Key", "expires_in_days": 30})
        ...
        mock_api_key_service.create_api_key.assert_called_once_with(
            user_id=mock_current_user.id, name="Test Key", expires_in_days=30
        )
    ...
    def test_revoke_api_key(
        ...
        # Make the request
        response = client.put("/auth/api-keys/revoke", json={"api_key": "test-api-key-to-revoke"})
    ...
    def test_revoke_api_key_by_id(
        ...
        # Make the request
        response = client.put("/auth/api-keys/revoke/1", json={"api_key_id": 1})
    ...
    def test_delete_api_key_forbidden(
        self,
        client: TestClient,
        mock_api_key_service,
        mock_db,
    ...
    def test_api_key_lifecycle(
        ...
        revoke_response = client.put("/auth/api-keys/revoke", json={"api_key": api_key_raw})
